...
export function EditorToolbar({ api, layer, canUndo, canRedo, onAddImage, onExport, onImport, onReset }: Props) {
  return <header className="editor-toolbar">
    ...
    <div className="project-actions"><button onClick={onImport}>Import</button><button onClick={onExport}>Export</button><button className="danger" onClick={onReset}>New</button></div>
  </header>;
}
